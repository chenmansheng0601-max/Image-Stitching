...
def train(opt):
    ...
    for filename in ['/opt/data/private/CMS/UnsupDIS-pytorch/utils/loss.py', '/opt/data/private/CMS/UnsupDIS-pytorch/utils/datasets.py', '/opt/data/private/CMS/UnsupDIS-pytorch/models/yolo.py', '/opt/data/private/CMS/UnsupDIS-pytorch/models/common.py', '/opt/data/private/CMS/UnsupDIS-pytorch/train.py', '/opt/data/private/CMS/UnsupDIS-pytorch/test.py']:
        shutil.copyfile(filename, sdir / os.path.basename(filename))
    # Configure
    ...
    # 读取 dino_params 配置
    # dino_params = read_yaml("/opt/data/private/CMS/UnsupDIS-pytorch/config/DINO/DINO_4scale_swin.yaml")
    ...
    if pretrained:
        ...
        # model = Model(opt.cfg or ckpt['model'].yaml, ch=3, mode_align=mode_align, dino_params=dino_params).to(device)  # create
        model = Model(opt.cfg or ckpt['model'].yaml, ch=3, mode_align=mode_align).to(device) 
        ...
        # model = Model(opt.cfg, ch=3, mode_align=mode_align, dino_params=dino_params).to(device)  # create
        model = Model(opt.cfg, ch=3, mode_align=mode_align).to(device) 
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--weights', type=str, default='/opt/data/private/CMS/UnsupDIS-pytorch/mask_rcnn_pvt_v2_b4_fpn_1x_coco.pth', help='initial weights path')
    # parser.add_argument('--cfg', type=str, default='/opt/data/private/CMS/UnsupDIS-pytorch/models/fuse_yolo.yaml', help='model.yaml path')
    # parser.add_argument('--data', type=str, default='/opt/data/private/CMS/UnsupDIS-pytorch/data/udis.yaml', help='data.yaml path')
    # parser.add_argument('--hyp', type=str, default='/opt/data/private/CMS/UnsupDIS-pytorch/data/hyp.fuse.scratch.yaml', help='hyperparameters path')
    ...
    # parser.add_argument('--reg-mode', default='crop', choices=['resize', 'crop'], help='image regularization')
    ...
    # parser.add_argument('--mode', default='fuse', choices=['align', 'fuse'], help='task mode, align or fuse')
    ...
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', type=str, default='/opt/data/private/CMS/UnsupDIS-pytorch/weights/yolov5m.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='/opt/data/private/CMS/UnsupDIS-pytorch/models/fuse_yolo.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='/opt/data/private/CMS/UnsupDIS-pytorch/data/udis.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='/opt/data/private/CMS/UnsupDIS-pytorch/data/hyp.fuse.scratch.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=30)
